    ...
    return Scaffold(
      body: Stack(
          children: [
            ...
            const Padding(padding: EdgeInsets.symmetric(vertical: 130,horizontal: 75),
            child: 
            ...
            const Padding(padding: EdgeInsets.symmetric(vertical: 200,horizontal: 40),
            child:  Text('Please write your email to recieve a confirmation\n                      code to set a new password',
             style: TextStyle(
              fontFamily: 'Lato',
             ...
             Padding(padding: const EdgeInsets.symmetric(vertical: 280,horizontal: 40),
            child: Column(
             ...
             Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> const VerifationPage()));
              }, style: ButtonStyle(
